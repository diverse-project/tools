...
public class EMFRegistryHelper {
	...
	/**
	 * checks if this URI is in the registry, and the EPackage already loaded
	 * 
	 * @param uri
	 * @return true if this URI is in the registry
	 */
	public static boolean isRegisteredAndLoaded(String uri) {
		Object registeredObj = Registry.INSTANCE.get(uri);
	...
	public static boolean isDynamicallyRegistered(String uri) {
		Object pack = Registry.INSTANCE.get(uri);
		if (pack == null)
			return false;
