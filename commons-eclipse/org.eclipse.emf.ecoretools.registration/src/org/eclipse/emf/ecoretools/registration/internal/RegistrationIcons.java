...
public class RegistrationIcons {
	...
	private void initialize() {
		try {
			...
			Image icon_lazygeneratedPackage = ImageDescriptor.createFromURL(new URL(pluginURL, "/icons/obj16/lazy_generated_package.png")).createImage(); //$NON-NLS-1$
			...
			icons.put(RegistrationConstants.IMG_LAZY_GENERATED_PACKAGE, icon_lazygeneratedPackage);
			icons.put(RegistrationConstants.IMG_GENERATED_PACKAGE, icon_generatedPackage);
			icons.put(RegistrationConstants.IMG_REFRESH, REFRESH_ICON_DESCRIPTOR.createImage());
			icons.put(RegistrationConstants.IMG_LOAD_LAZY_EPACKAGES, LOAD_LAZY_EPACKAGES_ICON_DESCRIPTOR.createImage());
