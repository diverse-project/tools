...
public abstract class AbstractExampleWizard extends Wizard
			...
			try {
				...
				case ASKUSER:
					 MessageDialog dialog = new MessageDialog(
						      null, "Project "+project.getName()+" already exist", null, "Project "+project.getName()+" already exist. Do you want to:",
						      MessageDialog.QUESTION,
						      new String[] {"Keep local version", "Replace with new version"},
	...
	public abstract ActionIfProjectExist getActionIfProjectExist(IProject project);
