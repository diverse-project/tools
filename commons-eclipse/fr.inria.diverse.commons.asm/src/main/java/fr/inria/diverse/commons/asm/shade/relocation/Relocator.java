package fr.inria.diverse.commons.asm.shade.relocation;
...
public interface Relocator extends Comparable<Relocator>
{
    ...
    String preApplyToSourceContent( String sourceContent );
    String finalizeApplyToSourceContent( String sourceContent );
}
