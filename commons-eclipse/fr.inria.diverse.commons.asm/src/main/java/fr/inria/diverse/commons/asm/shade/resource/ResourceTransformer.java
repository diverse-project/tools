...
{
    boolean canTransformResource( String resourceName );

    //void processResource( String resource, InputStream is, List<Relocator> relocators )
    //    throws IOException;

    String processResource( String resourceName, File resourceFile, File outputFolder, List<Relocator> relocators )
            throws IOException;
