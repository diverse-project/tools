package fr.inria.diverse.commons.asm.shade.filter;
    ...
    implements Filter
{
    ...
    public SimpleFilter( Set<File> folders, Set<String> includes, Set<String> excludes )
    {
        this.folders = ( folders != null ) ? new HashSet<File>( folders ) : new HashSet<File>();
        this.includes = normalizePatterns( includes );
        this.excludes = normalizePatterns( excludes );
    }

    public boolean canFilter( File folder )
    {
